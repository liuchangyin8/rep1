  ...
  <div class="ad-auth-box">
    <div class="row align-items-center">
      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class="ad-auth-img"><img src="assets/images/auth-img1.png" alt="" /></div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class="ad-auth-content">
          <form action="loginUser" method="post">
            <a href="index.jsp" class="ad-auth-logo"><img src="assets/images/logo2.png" alt="" /></a>
            <h2><span class="primary">您好,</span>欢迎!</h2>
            <p>输入账户密码来登录</p>
            <div class="ad-auth-form">
              <div class="ad-auth-feilds mb-30">
                <input type="text" placeholder="账户" name="uusername" class="ad-input" />
              ...
              <div class="ad-auth-feilds">
                <input type="password" placeholder="密码" name="upwd" class="ad-input" />
                <div class="ad-auth-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.8 482.8">
                    ...
                    <path d="M241.45,399.1c27.9,0,50.5-22.7,50.5-50.5c0-27.9-22.7-50.5-50.5-50.5c-27.9,0-50.5,22.7-50.5,50.5    S213.55,399.1,241.45,399.1z M241.45,325c13,0,23.5,10.6,23.5,23.5s-10.5,23.6-23.5,23.6s-23.5-10.6-23.5-23.5    S228.45,325,241.45,325z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#9abeed"></path>
                  </svg>
                </div>
              </div>
            </div>
            <div class="ad-other-feilds">
              ...
              <a class="forgot-pws-btn" href="forgot-pws.jsp">忘记密码？点我找回密码</a></div>
            <div class="ad-auth-btn"><input type="submit" class="ad-btn ad-login-member" value="登录"></div>
            <p class="ad-register-text">还没有账号？ <a href="register.jsp">点我</a>注册</p>
          </form>
        </div>
      </div>
    </div>
